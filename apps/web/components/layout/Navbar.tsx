      ...
      <div className="max-w-full px-4">
        <div className="flex items-center justify-between h-12">
          ...
          <div className="flex items-center gap-2">
            <Link
              href="/"
              className="flex items-center gap-2 hover:bg-gray-100 dark:hover:bg-[#272729] rounded-md px-2 py-1"
            >
          ...
          <div className="flex items-center gap-2">
            {!isLoading && !isAuthenticated ? (
              ...
              <>
                ...
                {/* Create Button */}
                <Link href={"/topics/create"} className="sm:flex">
                  <button className="hidden sm:flex items-center gap-1 px-3 py-2 hover:bg-gray-100 dark:hover:bg-[#272729] rounded-md text-gray-900 dark:text-gray-200">
                    <svg
                      className="w-5 h-5"
                      fill="none"
                      stroke="currentColor"
